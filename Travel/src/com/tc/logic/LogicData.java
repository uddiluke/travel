...
public class LogicData
{
    ...
    public static final String CG_GUIDE_LAST_UPDATE = "cgguidelastupdate";
    public static final String CG_MARK = "cgmark";
    public static final String CG_NEWS = "infors";
    ...
    public static final String KEY_CG_NEWS_MIN = "min";
